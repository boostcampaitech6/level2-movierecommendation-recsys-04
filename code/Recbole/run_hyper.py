...
def main():
    ...
    parser.add_argument(
        "--config_files", "-c", type=str, default=None, help="fixed config files"
    )
    parser.add_argument(
        "--params_file", "-p", type=str, default=None, help="parameters file"
    )
    parser.add_argument(
    ...
    args.params_file = os.path.join("./hyper", args.params_file + ".hyper")
