...
from src.trainers import FinetuneTrainer
...
def main(args):
    ...
    wandb.init(project='SASRec_tuning')
    
    ######################## WandB start run
    
    wandb.run.name = f'{save_time}_SASRec'
    wandb.run.save()
    ...
    generate_submission_file(args.data_file, preds, save_time)
