...
TARGET_DIR = os.path.join(os.getcwd(), "RecBole/dataset/movie")
...
print(f'✅ Created {TARGET_NAME} in {TARGET_DIR}')
...
FILE = '/data/ephemeral/RECBOLE/RecBole/dataset/movie/movie.csv'
